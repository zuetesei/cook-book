...
function About() {
  return (
    <div className="about-section">
      ...
      <p>
        {" "}
        Only Cooks is a blogging site that helps to connect people who are
        interested in cooking, creating, and sharing recipes! Come dicuss
        anything with your fellow chefs about any types of cuisine, anytime, any
      ...
      <a href="https://github.com/jonathonb1"> Jon Biala </a>,
